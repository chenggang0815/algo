...
/*
Approach:
1. use a Linked list and a index to record website
2. for each visit operation, before add url into list, we need to clear up all the forward history.
*/
public class BrowserHistory {
    ...
    public void visit(String url) {
        String lastPage = list.get(index);
        while (!lastPage.equals(list.getLast())) list.removeLast();
        list.add(url);
        index++;
    }
